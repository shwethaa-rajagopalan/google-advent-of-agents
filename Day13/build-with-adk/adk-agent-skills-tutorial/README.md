...
> Supporting code for [Building ADK Agents with Skills — From Inline to Meta](https://lavinigam.com/posts/adk-agent-skills-tutorial/)
...
cd build-with-adk/adk-agent-skills-tutorial
...
![SkillToolset progressive disclosure flow showing L1 metadata, L2 instructions, and L3 resources](assets/skilltoolset-flow.webp)
...
**[Building ADK Agents with Skills — From Inline to Meta](https://lavinigam.com/posts/adk-agent-skills-tutorial/)**
